    ...
    <div className="space-y-4">
      ...
      <Glass C={C}>
        ...
        <div className="space-y-1">
          {allocations.length===0 && (<div style={{color:C.tertiary,fontSize:12,fontFamily:FONT.text,textAlign:'center',padding:'20px 0'}}>Nessun asset in portafoglio — aggiungi le tue posizioni</div>)}
  ...
  return (
    <div className="space-y-4">
      <Glass C={C}>
        ...
        {equitySnap.length===0 && (<div style={{color:C.tertiary,fontSize:12,fontFamily:FONT.text,textAlign:'center',marginTop:-46,paddingBottom:24}}>Nessun dato storico — registra depositi e operazioni</div>)}
        <div className="flex items-center justify-between mt-2 pt-3" style={{borderTop:`0.5px solid ${C.sep}`}}>
          {[
      ...
      <Glass C={C}>
        ...
        <div className="space-y-1">
          {txFiltered.length===0 && (<div style={{color:C.tertiary,fontSize:12,fontFamily:FONT.text,textAlign:'center',padding:'20px 0'}}>Nessuna transazione registrata</div>)}
  ...
  return (
    <div className="space-y-4">
      ...
      <Glass C={C}>
        ...
        <div className="space-y-1">
          {assets.length===0 && (<div style={{color:C.tertiary,fontSize:12,fontFamily:FONT.text,textAlign:'center',padding:'20px 0'}}>Nessun asset — il ribilanciamento appare quando il portafoglio è popolato</div>)}
          {assets.map((a,idx)=>{
